...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@tailwind base;\r\n@tailwind components;\r\n@tailwind utilities;\r\n", "",{"version":3,"sources":["webpack://./src/styles/global.css"],"names":[],"mappings":"AAAA,cAAc;AACd,oBAAoB;AACpB,mBAAmB","sourcesContent":["@tailwind base;\r\n@tailwind components;\r\n@tailwind utilities;\r\n"],"sourceRoot":""}]);
// Exports
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "template-overlay:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunktemplate_overlay"] = self["webpackChunktemplate_overlay"] || [];
...
const { fontFamily: RichestList_fontFamily } = loadFont();
const richestPeople = [
  {
    name: "Elon Musk",
    netWorth: "$250B",
    company: "Tesla, SpaceX",
    image: "https://source.unsplash.com/200x200/?business,man"
  },
  {
    name: "Jeff Bezos",
    netWorth: "$180B",
    company: "Amazon",
    image: "https://source.unsplash.com/200x200/?tech,ceo"
  },
  {
    name: "Bernard Arnault",
    netWorth: "$190B",
    company: "LVMH",
    image: "https://source.unsplash.com/200x200/?luxury,ceo"
  },
  {
    name: "Bill Gates",
    netWorth: "$130B",
    company: "Microsoft",
    image: "https://source.unsplash.com/200x200/?entrepreneur"
  },
  {
    name: "Mark Zuckerberg",
    netWorth: "$120B",
    company: "Meta",
    image: "https://source.unsplash.com/200x200/?startup,founder"
  },
  {
    name: "Warren Buffett",
    netWorth: "$110B",
    company: "Berkshire Hathaway",
    image: "https://source.unsplash.com/200x200/?finance,investor"
  },
  {
    name: "Larry Page",
    netWorth: "$105B",
    company: "Google",
    image: "https://source.unsplash.com/200x200/?search,engineer"
  },
  {
    name: "Sergey Brin",
    netWorth: "$102B",
    company: "Google",
    image: "https://source.unsplash.com/200x200/?innovation"
  },
  {
    name: "Steve Ballmer",
    netWorth: "$100B",
    company: "Microsoft",
    image: "https://source.unsplash.com/200x200/?technology,leader"
  },
  {
    name: "Mukesh Ambani",
    netWorth: "$95B",
    company: "Reliance",
    image: "https://source.unsplash.com/200x200/?businessman"
  }
];
const RichestList = () => {
  const frame = (0,cjs.useCurrentFrame)();
  const { fps, width } = (0,cjs.useVideoConfig)();
  const itemEnter = Math.round(0.5 * fps);
  const itemHold = Math.round(1 * fps);
  const itemExit = Math.round(0.5 * fps);
  const itemDuration = itemEnter + itemHold + itemExit;
  const currentIndex = Math.floor(frame / itemDuration) % richestPeople.length;
  const progress = frame % itemDuration;
  let translateX = (0,cjs.interpolate)(progress, [0, itemEnter], [width, 0], {
    extrapolateRight: "clamp"
  });
  if (progress >= itemEnter && progress < itemEnter + itemHold) {
    translateX = 0;
  }
  const exitX = (0,cjs.interpolate)(
    progress,
    [itemEnter + itemHold, itemDuration],
    [0, -width],
    {
      extrapolateRight: "clamp"
    }
  );
  if (progress >= itemEnter + itemHold) {
    translateX = exitX;
  }
  const textScale = (0,cjs.interpolate)(
    progress,
    [itemEnter, itemEnter + itemHold / 2],
    [0.8, 1],
    {
      extrapolateRight: "clamp"
    }
  );
  const person = richestPeople[currentIndex];
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.AbsoluteFill, { style: {
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              fontFamily: RichestList_fontFamily
            },
...
var global = __webpack_require__(5171);
...
/* harmony default export */ const styles_global = (global/* default */.A.locals || {});
;// ./src/Root.tsx
